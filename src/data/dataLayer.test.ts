...
describe('mappers', () => {
  ...
  it('applies profile defaults for null columns', () => {
    const row = {
      ...
      rir_calibration_offset: null, rir_calibration_n: null, rir_calibration_updated: null, ml_alpha_cap: null, warmup_enabled: null, weight_unit: null, plate_system: null, periodization_enabled: null, volume_calibration: null,
